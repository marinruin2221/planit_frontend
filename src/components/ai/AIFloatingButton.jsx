  ...
  return (
    <>
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-[var(--brand_color)] text-white text-xs px-4 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap shadow-lg pointer-events-none">
          AI 여행 및 상담 도우미
        </span>
      </button>
